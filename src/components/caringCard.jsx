function CaringCard({ heading, icon }) {
  return (
    <div className="relative rounded-[20px] mt-[100px]">
      ...
      <div className="shadow-lg flex flex-col justify-center absolute top-[32vw] left-[7%] lg:top-[150px] lg:left-[15px] bg-custom-silver items-center p-[16px] w-[85%] lg:w-[300px] md:w-[48%] rounded-[20px] mt-[16px]">
